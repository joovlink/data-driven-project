...
export default function AddExperienceModal({ open, onClose }: Props) {
            ...
            <DialogContent className="max-w-3xl">
                ...
                <div>
                    ...
                    <DialogDescription className="text-sm">
                        Share your professional experience with job title, company, and responsibilities.
                    </DialogDescription>
                </div>

                {/* Form */}
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 max-h-[44vh] overflow-y-auto px-0.5 pr-4">
                    {/* Job Name */}
                    <div>
                        <Label>
                            Job Name <span className="text-red-500">*</span>
                        </Label>
                        <Input placeholder="e.g., IT Sales" {...register("job_name")} disabled={loading} />
                        {errors.job_name && (
                    ...
                    <div>
                        ...
                        <Input placeholder="e.g., Joovlink" {...register("company_name")} disabled={loading} />
                        {errors.company_name && (
                    ...
                    <div className="flex gap-2">
                        ...
                        {/* End Date (hanya kalau tidak contreng) */}
                        {!currentlyWorking && (
                            <div className="flex-1">
                    ...
                    <div>
                        ...
                        <Textarea
                            placeholder="Enter short description (min 100 character)"
                            rows={8}
