...
type CertificateForm = z.infer<typeof certSchema>
...
export default function AddCertificateModal({ open, onClose }: Props) {
            ...
            <DialogContent className="max-w-xl">
                ...
                <div>
                    ...
                    <DialogDescription className="text-sm">
                        Provide evidence of your qualifications, memberships, and authorized certifications.
                    </DialogDescription>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 px-0.5">
                    ...
                    <div>
                        <Label>Issuing organisation<span className="text-red-500">*</span></Label>
                        <Input placeholder="Organisation name" {...register("issuer")} />
                        {errors.issuer && (
                            <p className="text-xs text-red-500 mt-1">{errors.issuer.message}</p>
                        )}
                    </div>

                    <div>
                        <Label>Credential ID<span className="text-red-500">*</span></Label>
